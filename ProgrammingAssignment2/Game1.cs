...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sprite0 = Content.Load<Texture2D>(@"graphics\HeroSample");
            sprite1 = Content.Load<Texture2D>(@"graphics\Item-Talisman");
            sprite2 = Content.Load<Texture2D>(@"graphics\Menu-128.png");
