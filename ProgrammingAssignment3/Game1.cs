...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            rockSprite1 = Content.Load<Texture2D>(@"rs1");
            rockSprite2 = Content.Load<Texture2D>(@"rs2");
            rockSprite3 = Content.Load<Texture2D>(@"rs3");
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            // check rock availability then if it available update it
            if (rock1 != null)
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // STUDENTS: draw rocks
            spriteBatch.Begin();
            // check rock availability then if it available draw it
            if (rock1 != null)
